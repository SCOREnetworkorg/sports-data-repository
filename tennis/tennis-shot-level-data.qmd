...
There are 645905 unique shots recorded in ATP Australian Open matches, 486235 shots in ATP Roland Garros matches, 554405 shots in ATP US Open matches, and 418851 shots in ATP Wimbledon matches. There are 291905 unique shots recorded in WTA Australian Open matches, 196721 shots in WTA Roland Garros matches, 219855 shots in WTA US Open matches, and 175761 shots in WTA Wimbledon matches. 
...
| OutcomeType | Outcome type of shot, options are: `double_fault`, `winner`, `unforced_error`, `forced_error`, `ace`, `unreturnable` or `NA` (shot did not produce an outcome) |
...
: [tennis-m-shots-ao.gz](../data/tennis-m-shots-ao.csv.gz)

: [tennis-m-shots-rg.gz](../data/tennis-m-shots-rg.csv.gz)

: [tennis-m-shots-wim.gz](../data/tennis-m-shots-wim.csv.gz)

: [tennis-m-shots-uso.gz](../data/tennis-m-shots-uso.csv.gz)

: [tennis-w-shots-ao.gz](../data/tennis-w-shots-ao.csv.gz)

: [tennis-w-shots-rg.gz](../data/tennis-w-shots-rg.csv.gz)

: [tennis-w-shots-wim.gz](../data/tennis-w-shots-wim.csv.gz)

: [tennis-w-shots-uso.gz](../data/tennis-w-shots-uso.csv.gz)
